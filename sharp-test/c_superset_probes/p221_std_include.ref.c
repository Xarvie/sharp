...
#line 3 "sharp-test/c_superset_probes/../../std/str.sph"
...
#line 8 "sharp-test/c_superset_probes/../../std/str.sph"
static inline isize Str__find_byte(Str * this, char c);

#line 17 "sharp-test/c_superset_probes/../../std/str.sph"
static inline isize Str__size(Str * this);

#line 21 "sharp-test/c_superset_probes/../../std/str.sph"
static inline _Bool Str__op_eq(Str * this, Str other);

#line 31 "sharp-test/c_superset_probes/../../std/str.sph"
static inline _Bool Str__eq(Str * this, Str other);

#line 37 "sharp-test/c_superset_probes/../../std/str.sph"
static inline usize Str__hash(Str * this);

#line 48 "sharp-test/c_superset_probes/../../std/str.sph"
static inline _Bool Str__starts_with(Str * this, Str prefix);

#line 58 "sharp-test/c_superset_probes/../../std/str.sph"
static inline _Bool Str__ends_with(Str * this, Str suffix);

#line 69 "sharp-test/c_superset_probes/../../std/str.sph"
static inline Str Str__slice(Str * this, isize start, isize end);

#line 92 "sharp-test/c_superset_probes/../../std/str.sph"
struct StrSplit {
    Str left;
    Str right;
    _Bool found;
...
#line 12 "sharp-test/c_superset_probes/../../std/hashmap.sph"
const isize HASHMAP_EMPTY = 0;

#line 13 "sharp-test/c_superset_probes/../../std/hashmap.sph"
const isize HASHMAP_OCCUPIED = 1;

#line 14 "sharp-test/c_superset_probes/../../std/hashmap.sph"
const isize HASHMAP_TOMBSTONE = 2;

#line 16 "sharp-test/c_superset_probes/../../std/hashmap.sph"

#line 22 "sharp-test/c_superset_probes/../../std/hashmap.sph"

#line 54 "sharp-test/c_superset_probes/../../std/hashmap.sph"
...
#line 44 "sharp-test/c_superset_probes/../../std/vec.sph"
...
#line 9 "sharp-test/c_superset_probes/../../std/str.sph"
    isize i = 0;

#line 10 "sharp-test/c_superset_probes/../../std/str.sph"
    while (i < this->len) {

#line 11 "sharp-test/c_superset_probes/../../std/str.sph"
        if (this->ptr[i] == c) 
            return i;

#line 12 "sharp-test/c_superset_probes/../../std/str.sph"
        i = i + 1;
    }

#line 14 "sharp-test/c_superset_probes/../../std/str.sph"
    return -1;
}
...
#line 18 "sharp-test/c_superset_probes/../../std/str.sph"
    return this->len;
}
...
#line 22 "sharp-test/c_superset_probes/../../std/str.sph"
    if (this->len != other.len) 
        return 0;

#line 23 "sharp-test/c_superset_probes/../../std/str.sph"
    isize i = 0;

#line 24 "sharp-test/c_superset_probes/../../std/str.sph"
    while (i < this->len) {

#line 25 "sharp-test/c_superset_probes/../../std/str.sph"
        if (this->ptr[i] != other.ptr[i]) 
            return 0;

#line 26 "sharp-test/c_superset_probes/../../std/str.sph"
        i = i + 1;
    }

#line 28 "sharp-test/c_superset_probes/../../std/str.sph"
    return 1;
}
...
#line 32 "sharp-test/c_superset_probes/../../std/str.sph"
...
#line 38 "sharp-test/c_superset_probes/../../std/str.sph"
    usize h = (usize)14695981039346656037UL;

#line 39 "sharp-test/c_superset_probes/../../std/str.sph"
    isize i = 0;

#line 40 "sharp-test/c_superset_probes/../../std/str.sph"
    while (i < this->len) {

#line 41 "sharp-test/c_superset_probes/../../std/str.sph"
        h = h ^ (usize)(unsigned char)this->ptr[i];

#line 42 "sharp-test/c_superset_probes/../../std/str.sph"
        h = h * (usize)1099511628211UL;

#line 43 "sharp-test/c_superset_probes/../../std/str.sph"
        i = i + 1;
    }

#line 45 "sharp-test/c_superset_probes/../../std/str.sph"
    return h;
}
...
#line 49 "sharp-test/c_superset_probes/../../std/str.sph"
    if (prefix.len > this->len) 
        return 0;

#line 50 "sharp-test/c_superset_probes/../../std/str.sph"
    isize i = 0;

#line 51 "sharp-test/c_superset_probes/../../std/str.sph"
    while (i < prefix.len) {

#line 52 "sharp-test/c_superset_probes/../../std/str.sph"
        if (this->ptr[i] != prefix.ptr[i]) 
            return 0;

#line 53 "sharp-test/c_superset_probes/../../std/str.sph"
        i = i + 1;
    }

#line 55 "sharp-test/c_superset_probes/../../std/str.sph"
    return 1;
}
...
#line 59 "sharp-test/c_superset_probes/../../std/str.sph"
    if (suffix.len > this->len) 
        return 0;

#line 60 "sharp-test/c_superset_probes/../../std/str.sph"
    isize off = this->len - suffix.len;

#line 61 "sharp-test/c_superset_probes/../../std/str.sph"
    isize i = 0;

#line 62 "sharp-test/c_superset_probes/../../std/str.sph"
    while (i < suffix.len) {

#line 63 "sharp-test/c_superset_probes/../../std/str.sph"
        if (this->ptr[off + i] != suffix.ptr[i]) 
            return 0;

#line 64 "sharp-test/c_superset_probes/../../std/str.sph"
        i = i + 1;
    }

#line 66 "sharp-test/c_superset_probes/../../std/str.sph"
    return 1;
}
...
#line 70 "sharp-test/c_superset_probes/../../std/str.sph"
    if (start < 0 || end < start || end > this->len) 
        __builtin_trap();

#line 71 "sharp-test/c_superset_probes/../../std/str.sph"
    Str s;

#line 72 "sharp-test/c_superset_probes/../../std/str.sph"
    s.ptr = this->ptr + start;

#line 73 "sharp-test/c_superset_probes/../../std/str.sph"
    s.len = end - start;

#line 74 "sharp-test/c_superset_probes/../../std/str.sph"
    return s;
}

#line 77 "sharp-test/c_superset_probes/../../std/str.sph"
static inline Str str_from_lit(const char * lit) {

#line 78 "sharp-test/c_superset_probes/../../std/str.sph"
    Str s;

#line 79 "sharp-test/c_superset_probes/../../std/str.sph"
    s.ptr = lit;

#line 80 "sharp-test/c_superset_probes/../../std/str.sph"
    s.len = 0;

#line 81 "sharp-test/c_superset_probes/../../std/str.sph"
    while (lit[s.len] != 0) 
        s.len = s.len + 1;

#line 82 "sharp-test/c_superset_probes/../../std/str.sph"
    return s;
}

#line 85 "sharp-test/c_superset_probes/../../std/str.sph"
static inline Str str_from_parts(const char * p, isize len) {

#line 86 "sharp-test/c_superset_probes/../../std/str.sph"
    Str s;

#line 87 "sharp-test/c_superset_probes/../../std/str.sph"
    s.ptr = p;

#line 88 "sharp-test/c_superset_probes/../../std/str.sph"
    s.len = len;

#line 89 "sharp-test/c_superset_probes/../../std/str.sph"
    return s;
}

#line 98 "sharp-test/c_superset_probes/../../std/str.sph"
static inline struct StrSplit str_split_once(Str s, char sep) {

#line 99 "sharp-test/c_superset_probes/../../std/str.sph"
    isize idx = Str__find_byte(&s, sep);

#line 100 "sharp-test/c_superset_probes/../../std/str.sph"
    if (idx < 0) {

#line 101 "sharp-test/c_superset_probes/../../std/str.sph"
        struct StrSplit r;

#line 102 "sharp-test/c_superset_probes/../../std/str.sph"
        r.left = s;

#line 103 "sharp-test/c_superset_probes/../../std/str.sph"
        r.right = str_from_parts(s.ptr + s.len, 0);

#line 104 "sharp-test/c_superset_probes/../../std/str.sph"
        r.found = 0;

#line 105 "sharp-test/c_superset_probes/../../std/str.sph"
        return r;
    }

#line 107 "sharp-test/c_superset_probes/../../std/str.sph"
    struct StrSplit r;

#line 108 "sharp-test/c_superset_probes/../../std/str.sph"
    r.left = str_from_parts(s.ptr, idx);

#line 109 "sharp-test/c_superset_probes/../../std/str.sph"
    r.right = str_from_parts(s.ptr + idx + 1, s.len - idx - 1);

#line 110 "sharp-test/c_superset_probes/../../std/str.sph"
    r.found = 1;

#line 111 "sharp-test/c_superset_probes/../../std/str.sph"
    return r;
}
...
#line 45 "sharp-test/c_superset_probes/../../std/vec.sph"
    if (i < 0 || i >= this->len) 
        __builtin_trap();

#line 46 "sharp-test/c_superset_probes/../../std/vec.sph"
    return this->data[i];
}
