// 来源: p230_zero_init.sp, p232_typedef_chain.sp
// C互通: 零值初始化 + typedef 链
...
int main() {
    ...
    Position q;
    q.x = 4.0f; q.y = 5.0f; q.z = 6.0f;
    float d = p.dot(q);
    if (d < 31.99f || d > 32.01f) return 11;

    Point3D r3;
    r3.x = 0.0f; r3.y = 0.0f; r3.z = 1.0f;
    if (r3.dot(p) < 2.99f || r3.dot(p) > 3.01f) return 12;
