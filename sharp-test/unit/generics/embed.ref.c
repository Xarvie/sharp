...
#line 7 "sharp-test/unit/generics/embed.sp"

#line 17 "sharp-test/unit/generics/embed.sp"
...
#line 22 "sharp-test/unit/generics/embed.sp"
...
#line 12 "sharp-test/unit/generics/embed.sp"
_Bool Maybe__int__has_val(Maybe__int * this);

#line 14 "sharp-test/unit/generics/embed.sp"
void Maybe__int__set_val(Maybe__int * this, int v);

#line 13 "sharp-test/unit/generics/embed.sp"
...
#line 28 "sharp-test/unit/generics/embed.sp"
void Labeled__int__set_label(Labeled__int * this, int val);

#line 29 "sharp-test/unit/generics/embed.sp"
void Labeled__int__set_xy(Labeled__int * this, int x, int y);

#line 27 "sharp-test/unit/generics/embed.sp"
int Labeled__int__get_label(Labeled__int * this);

#line 30 "sharp-test/unit/generics/embed.sp"
...
#line 32 "sharp-test/unit/generics/embed.sp"
int main() {

#line 34 "sharp-test/unit/generics/embed.sp"
    Maybe__int mi = { 0 };

#line 35 "sharp-test/unit/generics/embed.sp"
    if (Maybe__int__has_val(&mi)) 
        return 1;

#line 37 "sharp-test/unit/generics/embed.sp"
    Maybe__int__set_val(&mi, 42);

#line 38 "sharp-test/unit/generics/embed.sp"
    if (!Maybe__int__has_val(&mi)) 
        return 2;

#line 39 "sharp-test/unit/generics/embed.sp"
    if (Maybe__int__get_val(&mi) != 42) 
        return 3;

#line 41 "sharp-test/unit/generics/embed.sp"
    Maybe__float mf = { 0 };

#line 42 "sharp-test/unit/generics/embed.sp"
    if (Maybe__float__has_val(&mf)) 
        return 4;

#line 44 "sharp-test/unit/generics/embed.sp"
    Maybe__float__set_val(&mf, 1.5f);

#line 45 "sharp-test/unit/generics/embed.sp"
    if (Maybe__float__get_val(&mf) < 1.49f || Maybe__float__get_val(&mf) > 1.51f) 
        return 5;

#line 48 "sharp-test/unit/generics/embed.sp"
    Labeled__int a = { 0 };

#line 49 "sharp-test/unit/generics/embed.sp"
    Labeled__int__set_label(&a, 42);

#line 50 "sharp-test/unit/generics/embed.sp"
    Labeled__int__set_xy(&a, 10, 20);

#line 52 "sharp-test/unit/generics/embed.sp"
    if (Labeled__int__get_label(&a) != 42) 
        return 6;

#line 53 "sharp-test/unit/generics/embed.sp"
    if (Labeled__int__pos_x(&a) != 10) 
        return 7;

#line 55 "sharp-test/unit/generics/embed.sp"
    Labeled__float b = { 0 };

#line 56 "sharp-test/unit/generics/embed.sp"
    Labeled__float__set_label(&b, 3.14f);

#line 57 "sharp-test/unit/generics/embed.sp"
    if (Labeled__float__get_label(&b) < 3.13f || Labeled__float__get_label(&b) > 3.15f) 
        return 8;

#line 59 "sharp-test/unit/generics/embed.sp"
    return 0;
}
