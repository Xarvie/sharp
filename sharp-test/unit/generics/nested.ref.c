...
#line 7 "sharp-test/unit/generics/nested.sp"
typedef long isize;

#line 8 "sharp-test/unit/generics/nested.sp"
typedef unsigned long usize;

#line 11 "sharp-test/unit/generics/nested.sp"

#line 46 "sharp-test/unit/generics/nested.sp"
...
#line 17 "sharp-test/unit/generics/nested.sp"
void Vec__int__push(Vec__int * this, int val);

#line 29 "sharp-test/unit/generics/nested.sp"
long Vec__int__size(Vec__int * this);

#line 33 "sharp-test/unit/generics/nested.sp"
int Vec__int__get(Vec__int * this, long i);

#line 38 "sharp-test/unit/generics/nested.sp"
...
#line 51 "sharp-test/unit/generics/nested.sp"
int main() {

#line 53 "sharp-test/unit/generics/nested.sp"
    Vec__int v = { 0 };

#line 54 "sharp-test/unit/generics/nested.sp"
    Vec__int__push(&v, 42);

#line 55 "sharp-test/unit/generics/nested.sp"
    Vec__int__push(&v, 73);

#line 56 "sharp-test/unit/generics/nested.sp"
    if (Vec__int__size(&v) != 2) 
        return 1;

#line 57 "sharp-test/unit/generics/nested.sp"
    if (Vec__int__get(&v, 0) != 42) 
        return 2;

#line 58 "sharp-test/unit/generics/nested.sp"
    if (Vec__int__get(&v, 1) != 73) 
        return 3;

#line 59 "sharp-test/unit/generics/nested.sp"
    Vec__int__destroy(&v);

#line 62 "sharp-test/unit/generics/nested.sp"
    Vec__float fv = { 0 };

#line 63 "sharp-test/unit/generics/nested.sp"
    Vec__float__push(&fv, 1.5f);

#line 64 "sharp-test/unit/generics/nested.sp"
    Vec__float__push(&fv, 2.5f);

#line 65 "sharp-test/unit/generics/nested.sp"
    if (Vec__float__size(&fv) != 2) 
        return 4;

#line 66 "sharp-test/unit/generics/nested.sp"
    if (Vec__float__get(&fv, 0) < 1.4f || Vec__float__get(&fv, 0) > 1.6f) 
        return 5;

#line 67 "sharp-test/unit/generics/nested.sp"
    Vec__float__destroy(&fv);

#line 70 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__Vec__int v3d = { 0 };

#line 71 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int inner2d = { 0 };

#line 72 "sharp-test/unit/generics/nested.sp"
    Vec__int inner1d = { 0 };

#line 73 "sharp-test/unit/generics/nested.sp"
    Vec__int__push(&inner1d, 42);

#line 74 "sharp-test/unit/generics/nested.sp"
    Vec__int__push(&inner1d, 73);

#line 75 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int__push(&inner2d, inner1d);

#line 76 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__Vec__int__push(&v3d, inner2d);

#line 78 "sharp-test/unit/generics/nested.sp"
    if (Vec__Vec__Vec__int__size(&v3d) != 1) 
        return 6;

#line 79 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int r2 = Vec__Vec__Vec__int__get(&v3d, 0);

#line 80 "sharp-test/unit/generics/nested.sp"
    if (Vec__Vec__int__size(&r2) != 1) 
        return 7;

#line 81 "sharp-test/unit/generics/nested.sp"
    Vec__int r1 = Vec__Vec__int__get(&r2, 0);

#line 82 "sharp-test/unit/generics/nested.sp"
    if (Vec__int__size(&r1) != 2) 
        return 8;

#line 83 "sharp-test/unit/generics/nested.sp"
    if (Vec__int__get(&r1, 0) != 42) 
        return 9;

#line 84 "sharp-test/unit/generics/nested.sp"
    Vec__int__destroy(&r1);

#line 85 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int__destroy(&r2);

#line 86 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__Vec__int__destroy(&v3d);

#line 89 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int m2d = { 0 };

#line 90 "sharp-test/unit/generics/nested.sp"
    Vec__int row0 = { 0 };

#line 91 "sharp-test/unit/generics/nested.sp"
    Vec__int row1 = { 0 };

#line 92 "sharp-test/unit/generics/nested.sp"
    Vec__int__push(&row0, 1);

#line 93 "sharp-test/unit/generics/nested.sp"
    Vec__int__push(&row1, 10);

#line 94 "sharp-test/unit/generics/nested.sp"
    Vec__int__push(&row1, 20);

#line 95 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int__push(&m2d, row0);

#line 96 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int__push(&m2d, row1);

#line 98 "sharp-test/unit/generics/nested.sp"
    if (Vec__Vec__int__size(&m2d) != 2) 
        return 10;

#line 99 "sharp-test/unit/generics/nested.sp"
    Vec__int c0 = Vec__Vec__int__get(&m2d, 0);

#line 100 "sharp-test/unit/generics/nested.sp"
    if (Vec__int__get(&c0, 0) != 1) 
        return 11;

#line 101 "sharp-test/unit/generics/nested.sp"
    Vec__int__destroy(&c0);

#line 102 "sharp-test/unit/generics/nested.sp"
    Vec__int c1 = Vec__Vec__int__get(&m2d, 1);

#line 103 "sharp-test/unit/generics/nested.sp"
    if (Vec__int__get(&c1, 1) != 20) 
        return 12;

#line 104 "sharp-test/unit/generics/nested.sp"
    Vec__int__destroy(&c1);

#line 105 "sharp-test/unit/generics/nested.sp"
    Vec__Vec__int__destroy(&m2d);

#line 108 "sharp-test/unit/generics/nested.sp"
    Pair__int__Vec__int pv = { 0 };

#line 109 "sharp-test/unit/generics/nested.sp"
    pv.first = 42;

#line 111 "sharp-test/unit/generics/nested.sp"
    return 0;
}
...
#line 18 "sharp-test/unit/generics/nested.sp"
    if (this->len >= this->cap) {

#line 19 "sharp-test/unit/generics/nested.sp"
        isize new_cap = (this->cap == 0) ? 8 : this->cap * 2;

#line 20 "sharp-test/unit/generics/nested.sp"
        int * nd = (int *)realloc(this->data, sizeof(int) * new_cap);

#line 21 "sharp-test/unit/generics/nested.sp"
        if (!nd) 
            __builtin_trap();

#line 22 "sharp-test/unit/generics/nested.sp"
        this->data = nd;

#line 23 "sharp-test/unit/generics/nested.sp"
        this->cap = new_cap;
    }

#line 25 "sharp-test/unit/generics/nested.sp"
    this->data[this->len] = val;

#line 26 "sharp-test/unit/generics/nested.sp"
    this->len = this->len + 1;
}
...
#line 30 "sharp-test/unit/generics/nested.sp"
    return this->len;
}
...
#line 34 "sharp-test/unit/generics/nested.sp"
    if (i < 0 || i >= this->len) 
        __builtin_trap();

#line 35 "sharp-test/unit/generics/nested.sp"
    return this->data[i];
}
...
#line 39 "sharp-test/unit/generics/nested.sp"
    free(this->data);

#line 40 "sharp-test/unit/generics/nested.sp"
    this->data = (int *)0;

#line 41 "sharp-test/unit/generics/nested.sp"
    this->len = 0;

#line 42 "sharp-test/unit/generics/nested.sp"
    this->cap = 0;
}
