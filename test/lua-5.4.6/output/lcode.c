...
#line 320 "src/lcode.c"
static void savelineinfo (FuncState *fs, Proto *f, int line) {
 int linedif = line - fs->previousline;
 int pc = fs->pc - 1;
 if (abs(linedif) >= 0x80 || fs->iwthabs++ >= 128) {
 (( f->abslineinfo)= (( AbsLineInfo *)( luaM_growaux_(fs->ls->L, f->abslineinfo, fs->nabslineinfo,&(
 f->sizeabslineinfo),sizeof( AbsLineInfo), (( ((size_t)( ( 2147483647  ))) <= ((size_t)(~(size_t)0))/sizeof( AbsLineInfo)) ? ( 2147483647  ) : ((unsigned int)( (( ((size_t)(~(size_t)0))/sizeof( AbsLineInfo)))))), "lines"))));
 f->abslineinfo[fs->nabslineinfo].pc = pc;
 f->abslineinfo[fs->nabslineinfo++].line = line;
 linedif = (-0x80);
 fs->iwthabs = 1;
 }
 (( f->lineinfo)= (( ls_byte *)( luaM_growaux_(fs->ls->L, f->lineinfo, pc,&( f->sizelineinfo),sizeof( ls_byte), (( ((size_t)( (
 2147483647  ))) <= ((size_t)(~(size_t)0))/sizeof( ls_byte)) ? (
 2147483647  ) : ((unsigned int)( (( ((size_t)(~(size_t)0))/sizeof( ls_byte)))))), "opcodes"))));
...
int luaK_code (FuncState *fs, Instruction i) {
 ...
 (( f->code)= (( Instruction *)( luaM_growaux_(fs->ls->L, f->code, fs->pc,&( f->sizecode),sizeof( Instruction), (( ((size_t)( (
 2147483647  ))) <= ((size_t)(~(size_t)0))/sizeof( Instruction)) ? (
 2147483647  ) : ((unsigned int)( (( ((size_t)(~(size_t)0))/sizeof( Instruction)))))), "opcodes"))));
 f->code[fs->pc++] = i;
...
static int constfolding (FuncState *fs, int op, expdesc *e1,
 ...
 static   OpCode binopr2op (BinOpr opr, BinOpr baser, OpCode base) {
 ((void)0);
 ...
 static   OpCode unopr2op (UnOpr opr) {
 ...
 static   TMS binopr2TM (BinOpr opr) {
 ((void)0);
