...
#pragma warning ( pop ) 
#line 13 "C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/ucrt/string.h"
...
#line 22 "src/lparser.c"
#line 1 "src/llex.h"


#line 23 "src/lparser.c"
#line 1 "src/lmem.h"



#line 24 "src/lparser.c"
#line 1 "src/lobject.h"




#line 25 "src/lparser.c"
#line 1 "src/lopcodes.h"


#line 26 "src/lparser.c"
#line 1 "src/lparser.h"


#line 27 "src/lparser.c"
#line 1 "src/lstate.h"



#line 28 "src/lparser.c"
...
static int registerlocalvar (LexState *ls, FuncState *fs, TString *varname) {
 ...
 (( f->locvars)= ((
 LocVar *)( luaM_growaux_(ls->L, f->locvars, fs->ndebugvars,&( f->sizelocvars),sizeof(
 LocVar), (( ((size_t)( ( 32767))) <= ((size_t)(~(size_t)0))/sizeof(
 LocVar)) ? ( 32767) : ((unsigned int)( (( ((size_t)(~(size_t)0))/sizeof(
...
static int new_localvar (LexState *ls, TString *name) {
 ...
 200, "local variables");
 (( dyd->actvar.arr)= (( Vardesc *)( luaM_growaux_(L, dyd->actvar.arr, dyd->actvar.n + 1,&(
 dyd->actvar.size),sizeof( Vardesc), (( ((size_t)( ( 0xffff))) <= ((size_t)(~(size_t)0))/sizeof( Vardesc)) ? ( 0xffff) : ((unsigned int)( (( ((size_t)(~(size_t)0))/sizeof( Vardesc)))))), "local variables"))));
...
static Upvaldesc *allocupvalue (FuncState *fs) {
 ...
 (( f->upvalues)= ((
 Upvaldesc *)( luaM_growaux_(fs->ls->L, f->upvalues, fs->nups,&( f->sizeupvalues),sizeof(
 Upvaldesc), (( ((size_t)( ( 255))) <= ((size_t)(~(size_t)0))/sizeof(
 Upvaldesc)) ? ( 255) : ((unsigned int)( (( ((size_t)(~(size_t)0))/sizeof(
 Upvaldesc)))))), "upvalues"))));
...
static int newlabelentry (LexState *ls, Labellist *l, TString *name,
 ...
 int n = l->n;
 (( l->arr)= ((
 Labeldesc *)( luaM_growaux_(ls->L, l->arr, n,&( l->size),sizeof(
 Labeldesc), (( ((size_t)( ( 32767))) <= ((size_t)(~(size_t)0))/sizeof(
 Labeldesc)) ? ( 32767) : ((unsigned int)( (( ((size_t)(~(size_t)0))/sizeof(
 Labeldesc)))))), "labels/gotos"))));
 l->arr[n].name = name;
 l->arr[n].line = line;
...
static void close_func (LexState *ls) {
 ...
 (( f->abslineinfo)= (( AbsLineInfo *)( luaM_shrinkvector_(L, f->abslineinfo, &( f->sizeabslineinfo), 
 fs->nabslineinfo, sizeof( AbsLineInfo)))));
...
static void simpleexp (LexState *ls, expdesc *v) {
 ...
 case TK_DOTS: {
 FuncState *fs = ls->fs;
 { if (!( fs->f->is_vararg)) luaX_syntaxerror(ls, 
...
LClosure *luaY_parser (lua_State *L, ZIO *z, Mbuffer *buff,
 ...
 { TValue *io = ( (&( L->top.p)->val)); LClosure *x_ = ( cl); ((io)->value_).gc = ( &( ((union GCUnion *)( (x_)))->gc)); ((io)->tt_=( (( (( 6) | (( 0) << 4))  ) | (1 << 6)))); ((void